...
class OfferAnalyzerPrompt {
  ...
  buildSystemPrompt() {
    ...
    const workModeClassification = [
      ...
      "REMOTE signifie que le travail à distance est explicitement présenté comme modalité de travail; HYBRID signifie une combinaison explicite de travail à distance et sur site; ONSITE signifie que l'offre indique explicitement que le poste ou travail est exercé en présentiel, ou que la présence physique au lieu de travail est requise comme condition d'exécution du poste.",
      "Pour ONSITE, cette indication explicite sur la manière ou le lieu d'exécution du poste suffit même sans formulation de politique formelle, de work arrangement ou de modalité de travail.",
      ...
      "Ne déduis jamais ONSITE d'une adresse, ville, localisation, nom de site, chantier, bureau, lieu de mission, métier physique, tâche opérationnelle, déplacement ou absence de télétravail pris seuls, sans déclaration explicite sur la manière ou le lieu d'exécution du poste.",
    ...
    const finalContractCheck = [
      ...
      "Pour ONSITE, conserve une classification explicitement soutenue lorsque le poste ou travail est déclaré en présentiel ou que la présence physique au lieu de travail est requise pour l'exécuter, même sans politique formelle d'organisation du travail.",
